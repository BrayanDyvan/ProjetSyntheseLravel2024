                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="{{route('jeux.create')}}">Ajouts <span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        <li><a href="{{route('jeux.create')}}"> jeu</a></li>
                                        <li><a href="{{route('jeux.categorie')}}">categorie</a></li>
                                        <li><a href="{{route('jeux.version')}}">version</a></li>
                                        <li><a href="{{route('jeux.image')}}">image</a></li>
