...
@section ('page', 'Ajout de la categorie')
...
<div class="container w-50 ">
  ...
  <div class="row text-dark mt-3 mb-3">
    ...
    @endif
      ...
      <form method="post" action="{{ route('jeux.storeJeuCategorie') }}">
        @csrf
          ...
          <div class="col-lg-6 col-md-6 trans">
            <div class="form-group">
              ...
              <select class="form-control w-100" id="jeu_id" name="jeu_id">
                ...
                @foreach($jeux as $jeuC)
          <option value="{{ $jeuC->id }}" {{ $jeuC->id == old('jeu_id') ? 'selected' : null }}>{{ $jeuC->nom }}
          </option>
      ...
      @endforeach
        ...
        <div class="row d-flex flex-row justify-content-between mb-5">
          ...
          <div>
            <a class="btn btn-default bg-danger text-white m-auto  " href="{{ route('jeux.version')}}">Terminer</a>
          </div>
