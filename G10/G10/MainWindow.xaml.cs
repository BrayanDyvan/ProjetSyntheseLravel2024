...
namespace G10
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private async void myButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            /*nE FONCTIONNE QUE QUAND NOUS SOMMES DANS UNE WINDOW ET NON DANS UNE PAGE*/
        ...
        private async void btn_ouvrir_Click(object sender, RoutedEventArgs e)
        {
            ...
            //tbl_texte.Text = await Windows.Storage.FileIO.ReadTextAsync(monFichier);
            //ouvre le fichier et lit le contenu
            if (monFichier != null)
            {
        ...
        private async void btn_Ecrire_Click(object sender, RoutedEventArgs e)
        {
            var picker = new Windows.Storage.Pickers.FileSavePicker();
        ...
        private async void btn_Ecrire_CSV_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void btn_Lire_CSV_Click(object sender, RoutedEventArgs e)
        {
            var picker = new Windows.Storage.Pickers.FileOpenPicker();
